...
export const useBoardCategoryList = <TSelected = ApiResponse<BoardCategory[]>>(options?: Omit<UseQueryOptions<ApiResponse<BoardCategory[]>, ApiError, TSelected>, "queryKey" | "queryFn">): UseQueryResult<TSelected, ApiError> => {
...
export const useBoardCategoryListSuspense = <TSelected = ApiResponse<BoardCategory[]>>(options?: Omit<UseSuspenseQueryOptions<ApiResponse<BoardCategory[]>, ApiError, TSelected>, "queryKey" | "queryFn">) => {
  const queryKey = boardCategoryQueryKeys.list();
  return useApiSuspenseQuery<BoardCategory[], TSelected>(queryKey, "/admin/board-categories", {
    ...options,
  });
};
