...
function mockCats(data: CatMap, isFetching = false, refetch = vi.fn().mockResolvedValue(undefined)) {
...
function mockBoards(data: SidebarBoard[], isFetching = false, refetch = vi.fn().mockResolvedValue(undefined)) {
